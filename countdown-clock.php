...
function countdown_clock_init() 
{
	...
	if ( $_POST['countdown-clock-submit'] ) {
	     ...
	     $options_flag=1;
      	...
      	echo '<ul><li style="text-align:center;list-style: none;"><label for="clock-title">Countdown Clock<br> by <a href="https://mycountdown.org">mycountdown.org</a></label></li>';
